...
procs = [
  ...
  PythonProcess("modem", "openpilot.common.hardware.comma.modem", always_run, enabled=COMMA_HARDWARE and (not NETWORK_DISABLED)),
  ...
  PythonProcess("webrtcd", "openpilot.system.webrtc.webrtcd", or_(livestream, notcar), enabled=not NETWORK_DISABLED),
